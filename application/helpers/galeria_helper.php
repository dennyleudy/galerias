...
<head>
    ...
    <title>Sube tu Panorma y Que disfruten los demas.</title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url('');?>">Galeria (T.8)</a>
            </div>
            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="<?php echo base_url('admin');?>">Sube tu Foto</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('web/acerca_de'); ?>">Sobre Administrador</a>
                    </li>
